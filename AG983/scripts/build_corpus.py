...
per scenario to:
    ...
    assignments/august2026/data/scenario_a/corpus.csv
    assignments/august2026/data/scenario_b/corpus.csv
    assignments/august2026/data/scenario_c/corpus.csv
    assignments/august2026/data/scenario_d/corpus.csv
...
Run from the repository root:
    ...
    python assignments/august2026/scripts/build_corpus.py
...
REPO_ROOT   = Path(__file__).resolve().parents[3]   # …/AG983
DATA_ROOT   = REPO_ROOT / "assignments" / "august2026" / "data"
